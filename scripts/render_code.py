...
class UnitFractionLogic(Scene):
    def construct(self):
        # 1. TASARIM STANDARTLARI
        self.camera.background_color = "#FFFFFF"
        dark_grey = "#333333"
        maarif_blue = "#87CEEB"
        
        # Tüm objelerin toplanacağı merkez noktası
        ...
        # 5. Birim Kesir Dilimi (MERKEZ KİLİTLİ)
        # arc_center kullanarak dilimi tam merkeze çiviliyoruz
        unit_slice = Sector(
