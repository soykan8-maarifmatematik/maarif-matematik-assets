...
class KesirlerinMantigi(Scene):
    def construct(self):
        ...
        slices = VGroup(*[Sector(arc_center=cake.get_center(), outer_radius=2, angle=TAU/9, start_angle=i*TAU/9, color=WHITE, stroke_color=DARK_GRAY, stroke_width=2, fill_opacity=1) for i in range(9)])
        ...
        pizza_slices = VGroup(*[Sector(outer_radius=1.5, angle=TAU/4, start_angle=i*TAU/4, color=WHITE, stroke_color=DARK_GRAY, stroke_width=2) for i in range(4)])
