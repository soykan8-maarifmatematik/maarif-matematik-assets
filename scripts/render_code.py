...
class BirimKesirMihlanmis(Scene):
    def construct(self):
        ...
        # Her şey ORIGIN (0,0,0) noktasına move_to ile sabitlendi
        ...
        self.play(Write(Text('Hoşça kalın...', color=BLUE, font_size=45).move_to(ORIGIN)))
        self.wait(2)